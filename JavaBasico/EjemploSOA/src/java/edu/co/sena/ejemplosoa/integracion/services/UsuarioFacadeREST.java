...
import edu.co.sena.ejemplosoa.integracion.entities.Usuario;
import edu.co.sena.ejemplosoa.integracion.entities.UsuarioPK;
 ...
 */
@Stateless
@Path("edu.co.sena.ejemplosoa.integracion.entities.usuario")
public class UsuarioFacadeREST extends AbstractFacade<Usuario> {
    ...
    private UsuarioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        edu.co.sena.ejemplosoa.integracion.entities.UsuarioPK key = new edu.co.sena.ejemplosoa.integracion.entities.UsuarioPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        edu.co.sena.ejemplosoa.integracion.entities.UsuarioPK key = getPrimaryKey(id);
