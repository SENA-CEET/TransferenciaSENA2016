...
import edu.co.sena.ejemplosoa.integracion.entities.Equipo;
 ...
 */
@Stateless
@Path("edu.co.sena.ejemplosoa.integracion.entities.equipo")
public class EquipoFacadeREST extends AbstractFacade<Equipo> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Equipo entity) {
        super.edit(entity);
    }
    ...
    public Equipo find(@PathParam("id") String id) {
