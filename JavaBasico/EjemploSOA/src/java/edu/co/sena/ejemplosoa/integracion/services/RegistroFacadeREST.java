...
import edu.co.sena.ejemplosoa.integracion.entities.Registro;
 ...
 */
@Stateless
@Path("edu.co.sena.ejemplosoa.integracion.entities.registro")
public class RegistroFacadeREST extends AbstractFacade<Registro> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Registro entity) {
        super.edit(entity);
    }
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Registro> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
