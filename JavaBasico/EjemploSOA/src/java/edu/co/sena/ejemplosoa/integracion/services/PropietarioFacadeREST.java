...
import edu.co.sena.ejemplosoa.integracion.entities.Propietario;
import edu.co.sena.ejemplosoa.integracion.entities.PropietarioPK;
 ...
 */
@Stateless
@Path("edu.co.sena.ejemplosoa.integracion.entities.propietario")
public class PropietarioFacadeREST extends AbstractFacade<Propietario> {
    ...
    private PropietarioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        edu.co.sena.ejemplosoa.integracion.entities.PropietarioPK key = new edu.co.sena.ejemplosoa.integracion.entities.PropietarioPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        edu.co.sena.ejemplosoa.integracion.entities.PropietarioPK key = getPrimaryKey(id);
